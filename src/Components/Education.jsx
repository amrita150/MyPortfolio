...
const Education = () => {
  ...
  return (
    <section className="flex justify-center items-center min-h-screen m-7">
      <div className="w-full max-w-3xl bg-white/10 backdrop-blur-md border border-white/20 rounded-3xl p-8 sm:p-13 shadow-2xl">
        <h2 className="text-2xl font-bold text-blue-300 text-center mb-8">
          Education
        </h2>
        <div className="relative">
          {/* Vertical Line */}
          <div className="absolute left-4 sm:left-1/2 transform sm:-translate-x-1/2 w-1 bg-white/30 h-full rounded-full"></div>
          ...
          <div className="space-y-6">
            {educationData.map((edu, index) => (
              ...
              >
                {/* Dot */}
                <div className="absolute left-4 sm:left-1/2 transform -translate-x-1/2 w-6 h-6 bg-pink-500 rounded-full border-3 border-white z-10 flex items-center justify-center">
                  <FaGraduationCap className="text-sm text-white" />
                </div>

                {/* Card - Now with more space */}
                <div
                  className={`bg-white/10 backdrop-blur-md border border-white/20 shadow-lg p-4 rounded-xl text-sm w-[90%] sm:w-[45%] 
                  ${
                    index % 2 === 0
                      ? "sm:ml-3 ml-10"
                      : "sm:mr-3 ml-10"
